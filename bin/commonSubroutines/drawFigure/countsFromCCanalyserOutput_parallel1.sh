...
# Turning on safety measures for cd rm and mv commands - restricting script to file operations "from this dir below" only :
HOME=$(pwd)
...
# This is counters from F1-F2 folders, to support --parallel 1 run type.
